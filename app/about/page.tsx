  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-12">
      ...
      <div className="mt-10 bg-green-600 rounded-2xl p-8 text-center text-white">
        ...
        <a href="/check" className="inline-block bg-white text-green-700 font-bold px-8 py-3 rounded-xl hover:bg-green-50 transition-colors text-sm">Start Scanning →</a>
      </div>
    </div>
  )
}
