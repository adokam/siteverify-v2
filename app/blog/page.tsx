...
export const metadata: Metadata = {
  title: 'Scam Alerts and Online Safety Blog | SiteVerify Nigeria',
...
const posts = [
  ...
  { slug: 'bunnyband-scam', title: 'BunnyBand — The Site That Never Pays and Steals Your Data', excerpt: 'BunnyBand shows you a welcome bonus you can never withdraw. We expose exactly how the trap works.', date: 'May 2026', tag: 'Data Harvest', danger: true },
  { slug: 'victuslink-scam', title: 'VictusLink — Classic Ponzi Scheme Targeting Nigerians', excerpt: 'VictusLink uses a suspicious domain, anonymous ownership, and unrealistic returns. Full analysis inside.', date: 'May 2026', tag: 'Ponzi Scheme', danger: true },
...
export default function BlogPage() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      <BackButton />
      <div className="mb-10">
        <h1 className="text-3xl font-extrabold text-gray-900 mb-3">Scam Alerts and Safety Blog</h1>
        <p className="text-gray-500">Latest scam exposés, safety guides, and online fraud warnings for Nigeria.</p>
      </div>
      <div className="grid md:grid-cols-2 gap-6">
        {posts.map(post => (
          <a key={post.slug} href={`/blog/${post.slug}`}
            className="group block bg-white rounded-2xl border border-gray-100 p-6 hover:border-green-200 hover:shadow-md transition-all">
