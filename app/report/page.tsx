    ...
    <div className="max-w-2xl mx-auto px-4 py-12">
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-500">
          Help protect other Nigerians. Report a fake website, investment platform, or fraudulent app and we will investigate it.
        </p>
      </div>
      <div className="bg-white rounded-2xl border border-gray-100 p-6 shadow-sm">
        <div className="space-y-5">
          <div>
            <label className="block text-sm font-semibold text-gray-700 mb-1.5">Website or Platform URL</label>
            <input type="text" placeholder="e.g. https://fakeinvestment.com"
          ...
          <div>
            ...
            <select className="w-full border border-gray-200 rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-green-500 transition-colors">
              ...
              <option>Phishing or Fake Bank Site</option>
              <option>Other</option>
            </select>
          </div>
          <div>
            <label className="block text-sm font-semibold text-gray-700 mb-1.5">What happened?</label>
            <textarea rows={4} placeholder="Describe your experience. What did they promise? What did you lose?"
          ...
          <p className="text-xs text-gray-400 text-center">
            Reports are reviewed and help improve our AI scam detection for everyone.
          </p>
        </div>
      </div>
    </div>
